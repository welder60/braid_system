...
urlpatterns = [
    ...
    path('admin-painel/estabelecimentos/<uuid:pk>/editar/',
         views.estabelecimento_editar, name='estabelecimento_editar'),
    path('admin-painel/estabelecimentos/<uuid:pk>/excluir/',
         views.estabelecimento_excluir, name='estabelecimento_excluir'),
    ...
    path('admin-painel/categorias-custo/<uuid:pk>/editar/',
         views.categoria_custo_editar, name='categoria_custo_editar'),
    path('admin-painel/categorias-custo/<uuid:pk>/excluir/',
         views.categoria_custo_excluir, name='categoria_custo_excluir'),

    # Caracteristicas de Atendimento
    path('admin-painel/caracteristicas-atendimento/',
         views.caracteristicas_atendimento, name='caracteristicas_atendimento'),
    path('admin-painel/caracteristicas-atendimento/criar/',
         views.caracteristica_atendimento_criar, name='caracteristica_atendimento_criar'),
    path('admin-painel/caracteristicas-atendimento/<uuid:pk>/editar/',
         views.caracteristica_atendimento_editar, name='caracteristica_atendimento_editar'),
    path('admin-painel/caracteristicas-atendimento/<uuid:pk>/excluir/',
         views.caracteristica_atendimento_excluir, name='caracteristica_atendimento_excluir'),
    path('admin-painel/caracteristicas-atendimento/<uuid:pk>/opcoes/',
         views.caracteristica_atendimento_opcoes, name='caracteristica_atendimento_opcoes'),
    path('admin-painel/caracteristicas-atendimento/<uuid:pk>/opcoes/criar/',
         views.opcao_caracteristica_criar, name='opcao_caracteristica_criar'),
    path('admin-painel/caracteristicas-atendimento/<uuid:pk>/opcoes/<uuid:opcao_pk>/editar/',
         views.opcao_caracteristica_editar, name='opcao_caracteristica_editar'),
    path('admin-painel/caracteristicas-atendimento/<uuid:pk>/opcoes/<uuid:opcao_pk>/excluir/',
         views.opcao_caracteristica_excluir, name='opcao_caracteristica_excluir'),
    ...
    path('admin-painel/formas-pagamento/<uuid:pk>/editar/',
         views.forma_pagamento_editar, name='forma_pagamento_editar'),
    path('admin-painel/formas-pagamento/<uuid:pk>/excluir/',
         views.forma_pagamento_excluir, name='forma_pagamento_excluir'),
    ...
    path('consultor/relatorios/atendimentos/',
         views.consultor_relatorio_atendimentos, name='consultor_relatorio_atendimentos'),
    path('consultor/relatorios/atendimentos/csv/', views.consultor_exportar_csv_atendimentos,
         name='consultor_exportar_csv_atendimentos'),
    path('consultor/dashboard-caracteristicas/', views.consultor_dashboard_caracteristicas,
